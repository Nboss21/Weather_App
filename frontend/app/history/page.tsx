    ...
    <div style={{ minHeight: "100vh", position: "relative" }}>
      ...
      >
        ...
        <div style={{ marginBottom: 28 }}>
          <h1
            style={{ fontSize: 26, fontWeight: 800, color: "white", margin: 0 }}
          >
            Weather{" "}
            <span
              style={{
        ...
        >
          ...
          {[
            ["JSON", "#22c55e", "rgba(34,197,94,0.15)"],
            ["CSV", "#3b82f6", "rgba(59,130,246,0.15)"],
            ["XML", "#f59e0b", "rgba(245,158,11,0.15)"],
            ["Markdown", "#a78bfa", "rgba(167,139,250,0.15)"],
          ].map(([label, color, bg]) => (
            <button
              key={label}
              onClick={() => exportData(label.toLowerCase())}
          ...
          <button
            onClick={loadRecords}
            style={{
              ...btn("rgba(255,255,255,0.7)", "rgba(255,255,255,0.07)"),
              marginLeft: "auto",
              border: "1px solid rgba(255,255,255,0.1)",
            }}
          >
            ...
            {records.map((r) => {
              ...
              return (
                <div key={r.id} style={{ ...glass, padding: "18px 20px" }}>
                  ...
                  >
                    ...
                    <div style={{ display: "flex", gap: 8, flexShrink: 0 }}>
                      <button
                        ...
                        style={{
                          ...btn("#38bdf8", "rgba(56,189,248,0.1)"),
                      ...
                      <button
                        ...
                        title="Edit record"
                        style={{
                          ...btn("#a78bfa", "rgba(167,139,250,0.1)"),
                  ...
                  >
                    Saved {new Date(r.createdAt).toLocaleString()} · ID #{r.id}{" "}
            ...
            {detailLoading ? (
              ...
              <>
                ...
                >
                  ...
                  >
                    {detail.context?.wikipediaSummary ||
                      "No Wikipedia summary available for this location."}
                  </p>
                </div>
                  ...
                  <div style={{ marginBottom: 16 }}>
                    ...
                    >
                      {[
                        [
                          "🌡️ Temperature",
                          `${Math.round(detail.weatherData.current.temperature_2m)}°C`,
                        ],
                        [
                          "🤔 Feels Like",
                          `${Math.round(detail.weatherData.current.apparent_temperature)}°C`,
                        ],
                        [
                          "💧 Humidity",
                          `${detail.weatherData.current.relative_humidity_2m}%`,
                        ],
                        [
                          "💨 Wind",
                          `${Math.round(detail.weatherData.current.wind_speed_10m)} km/h`,
                        ],
                      ].map(([label, val]) => (
                        <div
                          key={label}
      ...
      {editRecord && (
        ...
        >
          <div
            onClick={(e) => e.stopPropagation()}
            style={{ ...glass, maxWidth: 440, width: "100%", padding: 28 }}
          >
            <div
              style={{
                display: "flex",
            ...
            <div style={{ display: "flex", gap: 10, marginTop: 4 }}>
              ...
              <button
                onClick={() => setEditRecord(null)}
                style={{
                  ...btn("rgba(255,255,255,0.6)", "rgba(255,255,255,0.07)"),
                  border: "1px solid rgba(255,255,255,0.1)",
                  padding: "10px 16px",
                }}
              >
      ...
      {deleteId != null && (
        ...
        >
          ...
          >
            ...
            >
              This action cannot be undone. Record #{deleteId} will be
              permanently removed.
            </p>
